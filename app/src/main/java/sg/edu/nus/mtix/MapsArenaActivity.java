...
public class MapsArenaActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_arena);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationB.setLatitude(1.292423);
        ...
        Toast.makeText(this, "Distance from your location to Star Arena is: " + String.format("%.2f", distance) + "m", Toast.LENGTH_LONG).show();
    }
}
